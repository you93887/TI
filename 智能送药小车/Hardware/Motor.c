...
void Motor_Init()
{
    ...
    //配置F5、F4
	  ...
	  GPIOPinTypeGPIOOutput(GPIO_PORTH_BASE, GPIO_PIN_4);//右前  PWM0_0
    GPIOPinTypeGPIOOutput(GPIO_PORTH_BASE, GPIO_PIN_5);//右前  PWM0_0
		GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_5);//右后  PWM0_2
		GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_4);//右后  PWM0_2
	  GPIOPinTypeGPIOOutput(GPIO_PORTD_BASE, GPIO_PIN_0);//左前  PWM0_1
    GPIOPinTypeGPIOOutput(GPIO_PORTD_BASE, GPIO_PIN_1);//左前  PWM0_1
		GPIOPinTypeGPIOOutput(GPIO_PORTE_BASE, GPIO_PIN_3);//左后  PWM0_3
		GPIOPinTypeGPIOOutput(GPIO_PORTE_BASE, GPIO_PIN_2);//左后  PWM0_3
...
/**
  ...
  * 返 回 值：无
  */
void Motor_SetPwm1(float percent1)
{
	float Pwm1 = percent1/1000;
	if (Pwm1 >= 0)							//如果设置正转的速度值
	{
	  ...
	  GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_2, GPIO_PIN_2);
		SetDuty(PWM0_BASE,PWM_OUT_1,Pwm1);//PWM设置为速度值
	  SetDuty(PWM0_BASE,PWM_OUT_3,Pwm1);	
...
void Motor_SetPwm2(float percent)
{
	...
	if (Pwm2 >= 0)							//如果设置正转的速度值
	{
	  ...
	  GPIOPinWrite(GPIO_PORTH_BASE, GPIO_PIN_5, GPIO_PIN_5);	
		SetDuty(PWM0_BASE,PWM_OUT_0,Pwm2);//PWM设置为速度值
    SetDuty(PWM0_BASE,PWM_OUT_2,Pwm2);
